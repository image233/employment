...
const pages = {
    ...
    frontPage:{
        ...
        recruitmentBrochureDetailPage:()=>import('@/views/frontPage/recruitmentBrochureDetailPage.vue'),
        recruitmentBrochurePage:()=>import('@/views/frontPage/recruitmentBrochurePage.vue'),
        ...
        testinfo:()=>import('@/views/frontPage/testinfo.vue'),
        secleve:()=>import('@/views/frontPage/secleve.vue'),
        secleveDetail:()=>import('@/views/frontPage/secleveDetail.vue'),
    },
}
