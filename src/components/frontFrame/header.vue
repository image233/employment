<template>
    <div>
            <div  style="padding-top:40px;"><!-- class="css-out-content" -->
				...
				<div class="sech">
					<form id="search" action="">
			        <img class="here" src="/static/frontPage/imgs/logo.jpg"><!-- SchoolList.html -->
			        <div class="child"><router-link to="/frontPage/branchsit"><img src="/static/frontPage/imgs/here.jpg">&nbsp;进入子站&nbsp;<span>[切换分站]</span> </router-link></div>
			        <input type="text" name="keyword" class="inp" placeholder="请输入职位或公司"><input type="image" name="" class="btn" src="/static/frontPage/imgs/serach.jpg">
			        <div class="sou"><a href="#">程序员</a><a href="#">高薪名企</a><a href="#">收银员</a></div>
			    	</form>
			    </div>
			  </div>  
            </div>
            <div class="css-nav"   style="font-size:16px;">
            <div class="container">
                <div class="pull-left css-usernav" onmouseover="seen()" onmouseout="disn()" style="position: relative;" >
                    <span>用户功能频道</span>
                        <div class="css-box" id="css-box" style="width: 230px; height: 350px; display: none; position: absolute;top:50px; left: 0; z-index:999;">
